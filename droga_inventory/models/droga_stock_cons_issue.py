...
class droga_stock_cons_issue(models.Model):
    ...
    issue_type = fields.Selection([('CONI', 'Consignment'),('INC','Internal consumption'),('PRI','Project internal'),('PRC','Project contractor'), ('SIF', 'Free sample'),('SIR', 'Sample issue to be returned'),('SUBL','Cleaning unit issue'),('BAGI','Bag issue order')],string='Issue type', required=True)
