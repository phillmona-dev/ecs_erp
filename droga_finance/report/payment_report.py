...
select ap.partner_id,'Customer' as payment_type,'' as category,'' as division,'' as sales_channel,am."name" as invoice_no,am.sales_type,am.sales_initiator,
...
select ap.partner_id,'Vendor' as payment_type,'' as category,'' as division,'' as sales_channel,am."name" as invoice_no,am.sales_type,am.sales_initiator,
am.invoice_date_due,apr.max_date as paid_date,
