# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'views/pcm/droga_health_screening_report.xml',
        'views/reports/price_list_report.xml',
        'views/reports/health_screen_template.xml',
        # 'views/reports/blood_pressure_template.xml',
        # 'views/reports/weight_template.xml',
        'views/reports/health_screening_report.xml',
        # 'views/reports/glucose_template.xml',
